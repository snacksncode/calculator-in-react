...
export const Display = ({ firstNumber, secondNumber, answer, operator, easterEgg }: Props) => {
  ...
  return (
    <div className="flex-1 mb-2 flex px-5 flex-col items-end justify-end relative isolate">
      ...
      <div className="max-w-full rounded text-right font-bold text-slate-800">
        <div className="text-base text-blue-400 font-medium text-right opacity-80">
          <ScrollBlock theme="dark" className="whitespace-nowrap pb-2">
            {expression}
          </ScrollBlock>
        </div>
        <ScrollBlock theme="dark" className="pb-2 min-h-[56px] text-5xl">
          {getMainDisplay()}
        </ScrollBlock>
      </div>
    </div>
