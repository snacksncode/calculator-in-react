...
export const Display = ({ firstNumber, secondNumber, answer, operator, easterEgg }: Props) => {
  ...
  return (
    <div>
      <div className="text-base min-h-[32px] text-blue-400 font-medium text-right opacity-80">{expression}</div>
      <div className="relative isolate">
        ...
        <div className="flex items-center justify-end pr-3 overflow-auto text-4xl mt-2 min-h-[80px] rounded text-right font-bold bg-gradient-to-r from-sky-300 to-blue-300">
          {getMainDisplay()}
        </div>
